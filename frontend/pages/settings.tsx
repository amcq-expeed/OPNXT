  ...
  return (
    <div>
        ...
        <div className="card" role="region" aria-label="Security">
          ...
          <div style={{ marginTop: 8 }}>
            ...
            <div className="muted" style={{ fontSize: 12 }}>
              JWT is stored in localStorage for dev; consider rotating tokens
              regularly.
            </div>
          </div>
        </div>
      ...
      >
        ...
        {!admin && (
          <div style={{ color: "#a00", marginTop: 6 }}>
            You have read-only access. Contact an admin to update settings.
          </div>
        )}
      ...
      <div style={{ color: "#666", marginTop: 12, fontSize: 12 }}>
        Note: These settings update environment overrides at runtime. API keys
