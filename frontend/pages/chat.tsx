  ...
  return (
    <div>
      ...
      {selectedProject && (
        <NextAction
          message={
            "Capture or refine requirements here, then continue in the Project Workspace to apply them and generate documents."
          }
          primary={{
            label: "Open Workspace",
            href: `/projects/${selectedProject.project_id}?tab=Requirements`,
            variant: "primary",
          }}
          secondary={[
            {
              label: "Open Docs",
              href: `/projects/${selectedProject.project_id}?tab=Docs`,
            },
          ]}
        />
      )}
        ...
        <div className="columns-23">
          <div className="card">
            <ChatPanel
              ...
              onAIGenerateRequested={onAIGenerateFromChat}
              onRegenerateRequested={onRegenerateFromChat}
              ...
              <div style={{ display: "grid", gap: 8 }}>
                <div>
                  ...
                  <pre style={{ whiteSpace: "pre-wrap" }}>
                    {JSON.stringify(ctx.data?.summaries || {}, null, 2)}
                  </pre>
                </div>
                <div>
                  <strong>Answers</strong>
                  <pre style={{ whiteSpace: "pre-wrap" }}>
                    {JSON.stringify(ctx.data?.answers || {}, null, 2)}
                  </pre>
                </div>
              </div>
            )}
