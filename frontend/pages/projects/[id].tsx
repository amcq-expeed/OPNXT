                      ...
                      <li key={v.version}>
                        ...
                        previewVersion?.version === v.version ? (
                          ...
                          <button
                            ...
                            style={{ marginLeft: 8 }}
                            onClick={() =>
                              onPreviewVersion(selected, v.version)
                            }
                          >
                            Preview v{v.version}
                          </button>
  ...
  return (
    <div>
      ...
      <ProjectLaunchHero
        onSubmit={(idea) => {
          setChipPrefill(
            `Scenario: ${idea}. Please ask clarifying questions and propose SHALL-style requirements. Then we will generate Charter, SRS, SDD, and Test Plan.`,
          );
          try {
            router.push(`/projects/${id}?tab=Requirements`);
          } catch {}
        ...
        onScenarioSelect={(scenario) => {
          setChipPrefill(
            `Scenario: ${scenario.value}. Please ask clarifying questions and propose SHALL-style requirements. Then we will generate Charter, SRS, SDD, and Test Plan.`,
          );
          try {
            router.push(`/projects/${id}?tab=Requirements`);
          } catch {}
