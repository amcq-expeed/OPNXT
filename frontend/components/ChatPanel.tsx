...
export default function ChatPanel({
  ...
  return (
    <>
      <section
        className="chat-shell chat-shell--floating"
      ...
      >
        ...
        <div className="chat-shell__body">
          {!current || (current.messages?.length || 0) === 0 ? (
            <div className="chat-shell__empty muted">
              No messages yet. Describe the issue or idea you are working on and
              send it to start refining.
            </div>
          ) : (
        ...
        <form className="chat-shell__composer" onSubmit={onSend}>
          ...
          />
          <button
            className="btn btn-primary chat-shell__send"
            type="submit"
        ...
        <p className="chat-shell__tip chat-shell__tip--footer">
          Tip: You can start a new chat for a different refinement path. The
          assistant uses your project documents as context when available.
        </p>
      </section>
